                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 16px;">
                            ...
                            <a href="mailto:difajobs@gmail.com" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">difajobs@gmail.com</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Thanks, <br>DIFAJOBS Support Team</p>
                        </td>
                      </tr>
                      <tr>
